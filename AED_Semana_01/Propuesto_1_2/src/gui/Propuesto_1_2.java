...
public class Propuesto_1_2 extends JFrame implements ActionListener {
	...
	Docente d=new Docente();
	 ...
	 d.codigo=1001;
	 d.nombre="Fernando Diaz";
	 d.horasTrabajadas=48;
	 d.tarifaHora=8.8;
	 ...
	 DecimalFormat df = new DecimalFormat("#.00");
		...
		imprimir("horasTrabajadas  :" + d.horasTrabajadas);
		imprimir("tarifaHora       :" + d.tarifaHora);
		imprimir("sueldo           :" + df.format(d.sueldo()));
;
		imprimir("");
	}
