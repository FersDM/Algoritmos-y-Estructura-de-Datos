...
public class Problema_1_2 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		f.codigo = 1001;
		f.titulo = "Fernando Diaz";
		f.duracionMinutos = 60;
		f.precioSoles = 50;

		imprimir("Codigo             :" + f.codigo);
		imprimir("titulo             :" + f.titulo);
		imprimir("duracionMinutos    :" + f.duracionMinutos);
		imprimir("precioSoles        :" + f.precioSoles);
		imprimir("precioDolares      :" + f.precioDolares());
		imprimir("");
	}
